...
class AnimeVietSubProvider : MainAPI() {
    ...
    private val cfInterceptor = com.lagradost.cloudstream3.network.CloudflareKiller()
...
""".trimIndent()
    ...
    override suspend fun loadLinks(
        ...
        // GET player page via CloudflareKiller — bypasses Cloudflare, returns HTML with var avsToken
        val cfInt = com.lagradost.cloudstream3.network.CloudflareKiller()
        val playerHtml = try {
